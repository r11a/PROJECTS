export const stageMeta = {
  planning: { label: 'תכנון', color: '#7c6cf2', soft: '#eeeaff' },
  infrastructure: { label: 'תשתיות', color: '#e29b38', soft: '#fff3de' },
  installation: { label: 'התקנה', color: '#2987e6', soft: '#e7f3ff' },
  programming: { label: 'תכנות', color: '#12a594', soft: '#dcf8f3' },
  handover: { label: 'לקראת מסירה', color: '#d95984', soft: '#ffe8f0' },
  completed: { label: 'הושלם', color: '#1d9b66', soft: '#e2f7ed' },
};
