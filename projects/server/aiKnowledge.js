...
export const PRODUCT_CAPABILITIES = [
  ...
  { area:'טפסים ומסמכים', features:['תבניות וטפסים ממולאים','צילום והעלאה','תצוגה והורדה','אחסון פנימי או NAS','סל מחזור'] },
...
export const PRODUCT_HELP_GUIDE = [
  ...
  { area:'טפסים ומסמכים', keywords:['טופס','מסמך','קובץ','תמונה','וידאו','NAS','צילום'], purpose:'מרכז יצירה, העלאה, צפייה ושמירה של חומרי הפרויקט.', actions:['צילום מהטלפון או בחירת קובץ','תצוגה מקדימה והורדה','שיוך ישיר ללקוח או לפרויקט','שמירה באחסון הפנימי או בתיקיית NAS שהוגדרה','מחיקת מנהל לסל מחזור ושחזור בתקופת השמירה'], permissions:'מחיקה מותרת למנהל מערכת בלבד; הצפייה כפופה להרשאות הישות המשויכת.' },
