...
מבנה המערכת: תמונת מצב; לוח שנה; פרויקטים ומפה; לקוחות; אנשי מקצוע; מערכות ורכיבים; מסמכים והקלטות; תשלומים וגבייה; משימות ואבני דרך; דוחות וניתוחים; הגדרות. הגדרות ספק AI נמצאות תחת הגדרות ומערכת > סוכן AI.
